...
const PostCard: React.FC = () => {
  return (
    ...
    >
        ...
        <div>
          <h2 className="text-xl text-white font-bold">Post Title is the enssial part of the post that should be small not much big like this titel is getting bigger and bigger</h2>
